 ...
 */
var DB2QueryRunner = /** @class */ (function (_super) {
    __extends(DB2QueryRunner, _super);
    // -------------------------------------------------------------------------
    // Constructor
    // -------------------------------------------------------------------------
    function DB2QueryRunner(driver, mode) {
     ...
     */
    DB2QueryRunner.prototype.connect = function () {
        var _this = this;
     ...
     */
    DB2QueryRunner.prototype.release = function () {
        var _this = this;
     ...
     * Starts transaction.
     */
    DB2QueryRunner.prototype.startTransaction = function (isolationLevel) {
     ...
     */
    DB2QueryRunner.prototype.commitTransaction = function () {
        return __awaiter(this, void 0, void 0, function () {
            var beforeBroadcastResult, afterBroadcastResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Error will be thrown if transaction was not started.
     */
    DB2QueryRunner.prototype.rollbackTransaction = function () {
        return __awaiter(this, void 0, void 0, function () {
            var beforeBroadcastResult, afterBroadcastResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    DB2QueryRunner.prototype.query = function (query, parameters) {
        var _this = this;
        if (this.isReleased)
            throw new QueryRunnerAlreadyReleasedError();
        return new Promise(function (ok, fail) { return __awaiter(_this, void 0, void 0, function () {
            var queryStartTime_1, databaseConnection, err_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        databaseConnection.query(query, parameters || [], function (err, result) {
                            ...
                            var maxQueryExecutionTime = _this.driver.connection
     ...
     */
    DB2QueryRunner.prototype.stream = function (query, parameters, onEnd, onError) {
        var _this = this;
        if (this.isReleased)
            throw new QueryRunnerAlreadyReleasedError();
        return new Promise(function (ok, fail) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        databaseConnection = _a.sent();
                        this.driver.connection.logger.logQuery(query, parameters, this);
                        stream = databaseConnection.queryStream(query, parameters || []);
                        if (onEnd)
                            stream.on("end", onEnd);
                        if (onError)
     ...
     */
    DB2QueryRunner.prototype.getDatabases = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.getSchemas = function (database) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve([])];
            });
     ...
     */
    DB2QueryRunner.prototype.hasDatabase = function (database) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.hasSchema = function (schema) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.query("SELECT * FROM \"SYSIBM\".\"SYSTABLES\" WHERE \"CREATOR\" = '" + schema + "'")];
                    case 1:
                        result = _a.sent();
     ...
     */
    DB2QueryRunner.prototype.hasTable = function (tableOrName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        sql = "SELECT \"NAME\" FROM \"SYSIBM\".\"SYSTABLES\" WHERE \"NAME\" = '" + tableName + "'";
     ...
     */
    DB2QueryRunner.prototype.hasColumn = function (tableOrName, columnName) {
        return __awaiter(this, void 0, void 0, function () {
            var tableName, sql, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tableName = tableOrName instanceof Table ? tableOrName.name : tableOrName;
                        sql = "SELECT \"NAME\" FROM \"SYSIBM\".\"SYSCOLUMNS\" WHERE \"TBNAME\" = '" + tableName + "' AND \"NAME\" = '" + columnName + "'";
                        return [4 /*yield*/, this.query(sql)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.length ? true : false];
     ...
     */
    DB2QueryRunner.prototype.createDatabase = function (database, ifNotExist) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Drops database.
     */
    DB2QueryRunner.prototype.dropDatabase = function (database, ifExist) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve()];
            });
     ...
     */
    DB2QueryRunner.prototype.createSchema = function (schema, ifNotExist) {
        return __awaiter(this, void 0, void 0, function () {
            var up, down;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Drops table schema.
     */
    DB2QueryRunner.prototype.dropSchema = function (schemaPath, ifExist, isCascade) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, up, down;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        schema = schemaPath.indexOf(".") === -1
                            ? schemaPath
                            : schemaPath.split(".")[0];
                        up = ifExist
     ...
     * Creates a new table.
     */
    DB2QueryRunner.prototype.createTable = function (table, ifNotExist, createForeignKeys, createIndices) {
     ...
     * Drops the table.
     */
    DB2QueryRunner.prototype.dropTable = function (tableOrName, ifExist, dropForeignKeys, dropIndices) {
     ...
     * Creates a new view.
     */
    DB2QueryRunner.prototype.createView = function (view) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     * Drops the view.
     */
    DB2QueryRunner.prototype.dropView = function (target) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.renameTable = function (oldTableOrName, newTableOrName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        // rename table
                        upQueries.push(new Query("RENAME TABLE \"" + oldTable.name + "\" TO \"" + newTable.name + "\""));
                        downQueries.push(new Query("RENAME TABLE \"" + newTable.name + "\" TO \"" + oldTable.name + "\""));
                        ...
                        newTable.indices.forEach(function (index) {
                            ...
                            // build queries
                            upQueries.push(new Query("RENAME INDEX \"" + index.name + "\" TO \"" + newIndexName + "\""));
                            downQueries.push(new Query("RENAME INDEX \"" + newIndexName + "\" TO \"" + index.name + "\""));
                            // replace constraint name
     ...
     */
    DB2QueryRunner.prototype.addColumn = function (tableOrName, column) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.addColumns = function (tableOrName, columns) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.renameColumn = function (tableOrName, oldTableColumnOrName, newTableColumnOrName) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.changeColumn = function (tableOrName, oldTableColumnOrName, newColumn) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (!((newColumn.isGenerated !== oldColumn.isGenerated &&
                            ...
                            oldColumn.length !== newColumn.length)) return [3 /*break*/, 6];
     ...
     * Changes a column in the table.
     */
    DB2QueryRunner.prototype.changeColumns = function (tableOrName, changedColumns) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.dropColumn = function (tableOrName, columnOrName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        table = _a;
                        column = columnOrName instanceof TableColumn
                            ? columnOrName
                        ...
                        if (column.isPrimary) {
                            ...
                            columnNames = clonedTable.primaryColumns
                                .map(function (primaryColumn) { return "\"" + primaryColumn.name + "\""; })
                                .join(", ");
     ...
     */
    DB2QueryRunner.prototype.dropColumns = function (tableOrName, columns) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.createPrimaryKey = function (tableOrName, columnNames) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.updatePrimaryKeys = function (tableOrName, columns) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        columnNamesString = columnNames
                            .map(function (columnName) { return "\"" + columnName + "\""; })
                            .join(", ");
     ...
     * Drops a primary key.
     */
    DB2QueryRunner.prototype.dropPrimaryKey = function (tableOrName) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    DB2QueryRunner.prototype.createUniqueConstraint = function (tableOrName, uniqueConstraint) {
        return __awaiter(this, void 0, void 0, function () {
            var table, _a, up, down;
            return __generator(this, function (_b) {
                switch (_b.label) {
     ...
     */
    DB2QueryRunner.prototype.createUniqueConstraints = function (tableOrName, uniqueConstraints) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.dropUniqueConstraint = function (tableOrName, uniqueOrName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        table = _a;
                        uniqueConstraint = uniqueOrName instanceof TableUnique
                            ? uniqueOrName
     ...
     */
    DB2QueryRunner.prototype.dropUniqueConstraints = function (tableOrName, uniqueConstraints) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.createCheckConstraint = function (tableOrName, checkConstraint) {
        return __awaiter(this, void 0, void 0, function () {
            var table, _a, up, down;
            return __generator(this, function (_b) {
                switch (_b.label) {
     ...
     */
    DB2QueryRunner.prototype.createCheckConstraints = function (tableOrName, checkConstraints) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.dropCheckConstraint = function (tableOrName, checkOrName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        table = _a;
                        checkConstraint = checkOrName instanceof TableCheck
                            ? checkOrName
     ...
     */
    DB2QueryRunner.prototype.dropCheckConstraints = function (tableOrName, checkConstraints) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.createExclusionConstraint = function (tableOrName, exclusionConstraint) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.createExclusionConstraints = function (tableOrName, exclusionConstraints) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new Error("DB2 does not support exclusion constraints.");
            });
     ...
     */
    DB2QueryRunner.prototype.dropExclusionConstraint = function (tableOrName, exclusionOrName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new Error("DB2 does not support exclusion constraints.");
            });
     ...
     */
    DB2QueryRunner.prototype.dropExclusionConstraints = function (tableOrName, exclusionConstraints) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new Error("DB2 does not support exclusion constraints.");
            });
     ...
     */
    DB2QueryRunner.prototype.createForeignKey = function (tableOrName, foreignKey) {
        return __awaiter(this, void 0, void 0, function () {
            var table, _a, up, down;
            return __generator(this, function (_b) {
                switch (_b.label) {
     ...
     */
    DB2QueryRunner.prototype.createForeignKeys = function (tableOrName, foreignKeys) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.dropForeignKey = function (tableOrName, foreignKeyOrName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        table = _a;
                        foreignKey = foreignKeyOrName instanceof TableForeignKey
                            ? foreignKeyOrName
     ...
     */
    DB2QueryRunner.prototype.dropForeignKeys = function (tableOrName, foreignKeys) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * Creates a new index.
     */
    DB2QueryRunner.prototype.createIndex = function (tableOrName, index) {
        return __awaiter(this, void 0, void 0, function () {
            var table, _a, up, down;
            return __generator(this, function (_b) {
                switch (_b.label) {
     ...
     */
    DB2QueryRunner.prototype.createIndices = function (tableOrName, indices) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.dropIndex = function (tableOrName, indexOrName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        table = _a;
                        index = indexOrName instanceof TableIndex
                            ? indexOrName
     ...
     */
    DB2QueryRunner.prototype.dropIndices = function (tableOrName, indices) {
        return __awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    DB2QueryRunner.prototype.clearTable = function (tableName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    DB2QueryRunner.prototype.clearDatabase = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // Protected Methods
    // -------------------------------------------------------------------------
    DB2QueryRunner.prototype.loadViews = function (viewNames) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!hasTable)
                            return [2 /*return*/, Promise.resolve([])];
                        viewNamesString = viewNames
                            .map(function (viewName) {
                            var _a = __read(viewName.split("."), 2), schema = _a[0], name = _a[1];
                            if (!name) {
                                name = schema;
                                schema = _this.driver.options.schema;
                            }
                            return "(\"t\".\"schema\" = '" + schema + "' AND \"t\".\"name\" = '" + name + "')";
                        })
                            .join(" OR ");
                        query = "SELECT \"T\".* FROM \"" + this.getTypeormMetadataTableName() + "\" \"T\" INNER JOIN \"SYSCAT\".\"INDEXES\" \"V\" ON \"V\".\"TBNAME\" = \"T\".\"NAME\" WHERE \"T\".\"INDEXTYPE\" = '1'";
                        if (viewNamesString.length > 0)
                            query += " AND (" + viewNamesString + ")";
     ...
     */
    DB2QueryRunner.prototype.loadTables = function (tableNames) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!tableNames || !tableNames.length)
                            return [2 /*return*/, []];
                        tableNamesString = tableNames
                            .map(function (name) { return "'" + name + "'"; })
                            .join(", ");
                        tablesSql = "SELECT * FROM \"SYSCAT\".\"TABLES\" WHERE \"NAME\" IN (" + tableNamesString + ")";
                        columnsSql = "SELECT * FROM \"SYSCAT\".\"COLUMNS\" WHERE \"NAME\" IN (" + tableNamesString + ")";
                        indicesSql = "SELECT \"IND\".\"INDNAME\", \"IND\".\"TBNAME\", \"IND\".\"UNIQUERULE\" as \"UNIQUENESS\", " +
                        ...
                        return [2 /*return*/, dbTables.map(function (dbTable) {
                                ...
                                table.columns = dbColumns
                                    ...
                                    var isConstraintComposite = uniqueConstraint
                                        ? !!dbConstraints.find(function (dbConstraint) {
                                            return dbConstraint["CONSTRAINT_TYPE"] === "U" &&
                                    ...
                                    if (_this.driver.withLengthColumnTypes.indexOf(tableColumn.type) !== -1) {
                                        var length_1 = tableColumn.type === "raw"
                                            ? dbColumn["DATA_LENGTH"]
                                            : dbColumn["CHAR_COL_DECL_LENGTH"];
                                        tableColumn.length =
                                            length_1 &&
                                                !_this.isDefaultColumnLength(table, tableColumn, length_1)
                                                ? length_1.toString()
                                                : "";
                                    }
                                    if (tableColumn.type === "number" ||
                                        ...
                                        if (dbColumn["DATA_PRECISION"] !== null &&
                                            !_this.isDefaultColumnPrecision(table, tableColumn, dbColumn["DATA_PRECISION"]))
                                            tableColumn.precision = dbColumn["DATA_PRECISION"];
                                        if (dbColumn["DATA_SCALE"] !== null &&
                                            !_this.isDefaultColumnScale(table, tableColumn, dbColumn["DATA_SCALE"]))
                                        ...
                                        tableColumn.precision = !_this.isDefaultColumnPrecision(table, tableColumn, dbColumn["DATA_SCALE"])
                                            ? dbColumn["DATA_SCALE"]
                                            : undefined;
                                    }
                                    tableColumn.default =
     ...
     */
    DB2QueryRunner.prototype.createTableSql = function (table, createForeignKeys) {
        var _this = this;
        ...
        if (table.uniques.length > 0) {
            var uniquesSql = table.uniques
                .map(function (unique) {
                var uniqueName = unique.name
                    ? unique.name
                    : _this.connection.namingStrategy.uniqueConstraintName(table.name, unique.columnNames);
                var columnNames = unique.columnNames
                    .map(function (columnName) { return "\"" + columnName + "\""; })
                    .join(", ");
        ...
        if (table.checks.length > 0) {
            var checksSql = table.checks
                ...
                var checkName = check.name
                    ? check.name
                    : _this.connection.namingStrategy.checkConstraintName(table.name, check.expression);
     ...
     */
    DB2QueryRunner.prototype.dropTableSql = function (tableOrName, ifExist) {
    ...
    DB2QueryRunner.prototype.createViewSql = function (view) {
    ...
    DB2QueryRunner.prototype.insertViewDefinitionSql = function (view) {
        var expression = typeof view.expression === "string"
            ? view.expression.trim()
            : view.expression(this.connection).getQuery();
        var _a = __read(this.connection
            .createQueryBuilder()
            .insert()
     ...
     */
    DB2QueryRunner.prototype.dropViewSql = function (viewOrPath) {
     ...
     */
    DB2QueryRunner.prototype.deleteViewDefinitionSql = function (viewOrPath) {
        var viewName = viewOrPath instanceof View ? viewOrPath.name : viewOrPath;
     ...
     */
    DB2QueryRunner.prototype.createIndexSql = function (table, index) {
     ...
     */
    DB2QueryRunner.prototype.dropIndexSql = function (indexOrName) {
     ...
     */
    DB2QueryRunner.prototype.createPrimaryKeySql = function (table, columnNames) {
     ...
     */
    DB2QueryRunner.prototype.dropPrimaryKeySql = function (table) {
     ...
     */
    DB2QueryRunner.prototype.createUniqueConstraintSql = function (table, uniqueConstraint) {
     ...
     */
    DB2QueryRunner.prototype.dropUniqueConstraintSql = function (table, uniqueOrName) {
        var uniqueName = uniqueOrName instanceof TableUnique
            ? uniqueOrName.name
            : uniqueOrName;
     ...
     */
    DB2QueryRunner.prototype.createCheckConstraintSql = function (table, checkConstraint) {
        return new Query("ALTER TABLE \"" + table.name + "\" ADD CONSTRAINT \"" + checkConstraint.name + "\" CHECK (" + checkConstraint.expression + ")");
    };
    /**
     * Builds drop check constraint sql.
     */
    DB2QueryRunner.prototype.dropCheckConstraintSql = function (table, checkOrName) {
     ...
     */
    DB2QueryRunner.prototype.createForeignKeySql = function (table, foreignKey) {
     ...
     */
    DB2QueryRunner.prototype.dropForeignKeySql = function (table, foreignKeyOrName) {
        var foreignKeyName = foreignKeyOrName instanceof TableForeignKey
     ...
     */
    DB2QueryRunner.prototype.buildCreateColumnSql = function (column) {
    ...
    return DB2QueryRunner;
}(BaseQueryRunner));
export { DB2QueryRunner };

//# sourceMappingURL=DB2QueryRunner.js.map
