...
var DB2Driver = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.master)
                            return [2 /*return*/, Promise.reject(new ConnectionIsNotSetError("DB2"))];
    ...
    DB2Driver.prototype.obtainMasterConnection = function () {
        ...
        return new Promise(function (ok, fail) {
            var credentials = Object.assign({}, _this.options, DriverUtils.buildDriverOptions(_this.options)); // todo: do it better way
