 ...
 */
export declare class DB2Driver implements Driver {
    /**
     ...
     */
    createQueryRunner(mode: ReplicationMode): DB2QueryRunner;
    /**
     ...
     */
    protected createPool(options: DB2ConnectionOptions, credentials: DB2ConnectionCredentialsOptions): Promise<any>;
    /**
