...
var DB2QueryRunner = /** @class */ (function (_super) {
    tslib_1.__extends(DB2QueryRunner, _super);
    // -------------------------------------------------------------------------
    // Constructor
    // -------------------------------------------------------------------------
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        // rename table
                        upQueries.push(new Query_1.Query("RENAME TABLE \"" + oldTable.name + "\" TO \"" + newTable.name + "\""));
                        downQueries.push(new Query_1.Query("RENAME TABLE \"" + newTable.name + "\" TO \"" + oldTable.name + "\""));
                        ...
                        newTable.indices.forEach(function (index) {
                            ...
                            // build queries
                            upQueries.push(new Query_1.Query("RENAME INDEX \"" + index.name + "\" TO \"" + newIndexName + "\""));
                            downQueries.push(new Query_1.Query("RENAME INDEX \"" + newIndexName + "\" TO \"" + index.name + "\""));
                            // replace constraint name
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        table = _a;
                        uniqueConstraint = uniqueOrName instanceof TableUnique_1.TableUnique
                            ? uniqueOrName
                        ...
                        return [2 /*return*/, dbTables.map(function (dbTable) {
                                ...
                                table.columns = dbColumns
                                    ...
                                    if (_this.driver.withLengthColumnTypes.indexOf(tableColumn.type) !== -1) {
                                        var length = tableColumn.type === "raw"
                                            ? dbColumn["DATA_LENGTH"]
                                            : dbColumn["CHAR_COL_DECL_LENGTH"];
                                        tableColumn.length =
                                            length &&
                                                !_this.isDefaultColumnLength(table, tableColumn, length)
                                                ? length.toString()
                                                : "";
                                    }
    ...
    DB2QueryRunner.prototype.insertViewDefinitionSql = function (view) {
        ...
        var _a = tslib_1.__read(this.connection
            .createQueryBuilder()
            .insert()
    ...
    DB2QueryRunner.prototype.dropUniqueConstraintSql = function (table, uniqueOrName) {
        var uniqueName = uniqueOrName instanceof TableUnique_1.TableUnique
            ? uniqueOrName.name
            : uniqueOrName;
...
exports.DB2QueryRunner = DB2QueryRunner;
