...
var DB2Driver_1 = require("../driver/db2/DB2Driver");
/**
...
var SelectQueryBuilder = /** @class */ (function (_super) {
    ...
    SelectQueryBuilder.prototype.buildEscapedEntityColumnSelects = function (aliasName, metadata) {
        ...
        return allColumns.map(function (column) {
            ...
            if (column.type === "json" &&
                _this.connection.driver instanceof DB2Driver_1.DB2Driver) {
    ...
    SelectQueryBuilder.prototype.computeCountExpression = function () {
        ...
        if (this.connection.driver instanceof CockroachDriver_1.CockroachDriver ||
            ...
            return ("COUNT(DISTINCT(" +
                primaryColumns
                    .map(function (c) { return distinctAlias + "." + _this.escape(c.databaseName); })
                    .join(", ") +
                "))");
        }
        ...
        if (this.connection.driver instanceof SqlServerDriver_1.SqlServerDriver) {
            ...
            var columnsExpression = primaryColumns
                        ...
                        if (metadata_1.hasMultiplePrimaryKeys) {
                            ...
                            if (areAllNumbers) {
                                ...
                                condition =
                                    mainAliasName_1 +
                                        "." +
                                        metadata_1.primaryColumns[0].propertyPath +
                                        " IN (:...orm_distinct_ids)";
                            }
                        }
                        return [4 /*yield*/, this.clone()
